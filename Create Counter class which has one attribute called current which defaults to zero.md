...
The Counter class has an init method that initializes an instance variable current to 0. This variable holds the current count.
...
<img width="356" height="176" alt="image" src="https://github.com/user-attachments/assets/caa64fef-d555-405e-acc1-a7bf2f3a563d" />
